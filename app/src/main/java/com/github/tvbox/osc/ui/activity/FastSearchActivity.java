...
//      mGridView.setLayoutManager(new V7GridLayoutManager(this.mContext, 5));   // 快速搜索中的缩略图截断（显示 4 而不是 5）
...
//      mGridViewFilter.setLayoutManager(new V7GridLayoutManager(this.mContext, 5));   // 快速搜索中的缩略图截断（显示 4 而不是 5）
